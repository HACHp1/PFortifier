...
Yield = node('Yield', ['keyvar', 'valvar'])
...
Function = node('Function', ['name', 'params',
                             'nodes', 'is_ref', 'returntype'])
Method = node('Method', ['name', 'modifiers', 'params',
                         'nodes', 'is_ref', 'returntype'])
Closure = node('Closure', ['params', 'vars', 'nodes', 'is_ref'])
Class = node('Class', ['name', 'type', 'extends',
                       'implements', 'traits', 'nodes'])
...
FormalParameter = node('FormalParameter', [
                       'name', 'default', 'is_ref', 'type'])
...
UseDeclaration = node('UseDeclaration', ['name', 'alias', 'type'])
...
TraitModifier = node(
    'TraitModifier', ['vfrom', 'vto', 'insteadof', 'visibility'])
