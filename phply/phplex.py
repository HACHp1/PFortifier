...
reserved = (
    ...
    'EXTENDS', 'FOR', 'FOREACH', 'FUNCTION', 'FN', 'GLOBAL', 'IF', 'INCLUDE',
    ...
    'FINALLY', 'TRAIT', 'YIELD', 'FROM', 'INSTEADOF', 'GOTO',
)
...
tokens = reserved + unparsed + (
    # Operators
    'PLUS', 'MINUS', 'MUL', 'EXP', 'DIV', 'MOD', 'AND', 'OR', 'NOT', 'XOR', 'SL',
    'SR', 'BOOLEAN_AND', 'BOOLEAN_OR', 'BOOLEAN_NOT', 'IS_SMALLER',
    'IS_GREATER', 'IS_SMALLER_OR_EQUAL', 'IS_GREATER_OR_EQUAL', 'IS_EQUAL',
    'IS_NOT_EQUAL', 'IS_IDENTICAL', 'IS_NOT_IDENTICAL', 'DOUBLE_QUESTION',
    'SPACESHIP', 'SPLAT',


    # Assignment operators
    'EQUALS', 'MUL_EQUAL', 'EXP_EQUAL', 'DIV_EQUAL', 'MOD_EQUAL', 'PLUS_EQUAL',
    'MINUS_EQUAL', 'SL_EQUAL', 'SR_EQUAL', 'AND_EQUAL', 'OR_EQUAL',
    'XOR_EQUAL', 'CONCAT_EQUAL', 'DOUBLE_QUESTION_EQUAL',
